...
namespace AcademicChatBot.Service.Contract
{
    public interface ICurriculumService
    {
        ...
        Task<Response> GetAllCurriculums(int pageNumber, int pageSize, string search, SortBy sortBy, SortType sortType, bool isDeleted);
        ...
        Task<Response> GetCurriculumByCode(int pageNumber, int pageSize, string curriculumCode, SortBy sortBy, SortType sortType, bool isDeleted);
    }
}
